import { JanusResponse } from '../janus.types';

export default {
    error: {
        general: {
            unauthorized(req): JanusResponse {
                return {
                    janus: 'error',
    ...
    general: {
        info: function info(req): JanusResponse {
            return {
                janus: 'server_info',
                transaction: req.transaction,
                ...
                transports: {
                    'janus.transport.rabbitmq': {
                        ...
                        author: 'Meetecho s.r.l.',
                        description:
                            'This transport plugin adds RabbitMQ support to the Janus API via rabbitmq-c.',
    ...
    session: {
        ...
        createVideoRoomHandle(req, handle): JanusResponse {
            return {
                janus: 'success',
                session_id: req.session_id,
                transaction: req.transaction,
    ...
    videoRoomHandle: {
        ...
        listParticipants(req): JanusResponse {
            return {
                janus: 'success',
                session_id: req.session_id,
                sender: req.handle_id,
                        ...
                        participants: [
                            {
                                ...
                                publisher: true,
                                talking: false,
                                internal_audio_ssrc: 0,
                                internal_video_ssrc: 0,
                            },
                            {
                                id: 2,
                                publisher: 'true',
